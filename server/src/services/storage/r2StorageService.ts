  ...
  constructor() {
    ...
    if (process.env.S3_ACCESS_KEY_ID && process.env.S3_SECRET_ACCESS_KEY) {
      ...
      this.client = new S3Client({
        ...
        endpoint: process.env.S3_ENDPOINT || "https://us-east-1.r2.cloudflarestorage.com",
        credentials: {
      ...
      this.enabled = true;
      this.logger.info({ bucket: this.bucketName }, "S3Storage initialized");
    } else {
      this.logger.debug("S3Storage not enabled - missing S3 credentials");
    }
  }
